        ...
        <div class="card-body">
            ...
            <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <select wire:model="team_department" class="form-control">
                            ...
                            @foreach ($departments as $key=>$value)
                                <option value="{{$value->id}}">DEPT-{{$value->id}} ({{$value->name}})</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                ...
                <div class="col-sm-12">
                        ...
                        <br><br>
                    <table id="tblTeams" class="table table-hover table-borderless table-sm table-striped table-reponsive-sm w-100">
                        <thead>
                            <tr>
                                <th>Team ID</th>
                                <th>Lead Name</th>
                        ...
                        <tbody>
                            ...
                            @foreach ($teams as $key=>$value)
                                <tr>
                                    ...
                                    <td>
                                        <a href="/team/{{$value->id}}" wire:navigate class="btn border-0 btn-outline-info rounded-circle"><i class="bx bx-edit"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                            @endif
